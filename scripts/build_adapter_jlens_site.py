...
<body><main id="app">
  ...
  <section class="overview"><div class="section-head"><div><h2>Selected prompts at frozen layer 40</h2><p>Each point is one response-averaged prompt. Below the diagonal means J-Lens gives the secret a better rank.</p></div><div class="legend"><span><i class="dot direct"></i>direct</span><span><i class="dot standard"></i>standard</span><span><i class="dot leak"></i>literal leak</span></div></div><svg id="scatter" aria-label="J-Lens rank versus Logit Lens rank by prompt"></svg></section>
